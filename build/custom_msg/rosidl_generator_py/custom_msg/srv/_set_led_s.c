...
bool custom_msg__srv__set_led__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msg.srv._set_led.SetLed_Request", full_classname_dest, 38) == 0);
  }
  custom_msg__srv__SetLed_Request * ros_message = _ros_message;
  {  // a
...
PyObject * custom_msg__srv__set_led__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msg.srv._set_led");
...
ROSIDL_GENERATOR_C_EXPORT
bool custom_msg__srv__set_led__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msg.srv._set_led.SetLed_Response", full_classname_dest, 39) == 0);
  }
  custom_msg__srv__SetLed_Response * ros_message = _ros_message;
  {  // sum
