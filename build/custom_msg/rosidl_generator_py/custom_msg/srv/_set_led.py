...
class Metaclass_SetLed(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from custom_msg.srv import _set_led
...
class SetLed(metaclass=Metaclass_SetLed):
    from custom_msg.srv._set_led import SetLed_Request as Request
    from custom_msg.srv._set_led import SetLed_Response as Response
