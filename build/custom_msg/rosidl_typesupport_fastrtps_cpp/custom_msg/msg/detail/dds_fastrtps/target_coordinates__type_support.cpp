...
#include "custom_msg/msg/detail/target_coordinates__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msg::msg::TargetCoordinates & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msg::msg::TargetCoordinates & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
...
{
  auto typed_message =
    static_cast<const custom_msg::msg::TargetCoordinates *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msg::msg::TargetCoordinates *>(
    untyped_ros_message);
...
{
  return &custom_msg::msg::typesupport_fastrtps_cpp::_TargetCoordinates__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msg, msg, TargetCoordinates)() {
  return &custom_msg::msg::typesupport_fastrtps_cpp::_TargetCoordinates__handle;
}
